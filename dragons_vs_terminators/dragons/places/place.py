class Place(object):
    ...
    def add_fighter(self, fighter):
        ...
        if fighter.is_dragon:
            if self.dragon is None:
                self.dragon = fighter
            elif self.dragon.is_container and self.dragon.can_contain(fighter):
                self.dragon.contain_dragon(fighter)
            elif fighter.is_container and fighter.can_contain(self.dragon):
    ...
    def remove_fighter(self, fighter):
        ...
        if fighter.is_dragon:
            ...
            # BEGIN 4.3
            "*** YOUR CODE HERE ***"
            if fighter.name is "King" and fighter.instantiated is False:
                return
            # END 4.3
